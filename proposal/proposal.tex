...
communication(OTR) \cite{otr}. The OTR protocol amied at providing the
beforementioned properties for chats with two participants. However in 2005 Di
...
Alexander et al.\ attendet the problem of exchanging public keys 
...
group OTR algorithm under a standardized interface usable by various existing IM
